...
/** Hauteur réservée au contenu au-dessus du dock flottant. */
export const GLASS_DOCK_CONTENT_INSET = 108;

/**
 * Dock Liquid Glass — look validé (playground) porté pour COR·ALT.
